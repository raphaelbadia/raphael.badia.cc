		...
		<>
			...
			<ExperienceBody>
				...
				<div className="my-3">
					...
					centre” et “édition du praticien”, et que les praticiens héritent des
					réglages du centre. Ces pages contenaient:
					<ul className="list-disc">
						...
						<li>
							...
							personnalisation, tri drag&drop, suppression et réattribution des
							rendez-vous du motif supprimé)
						</li>
