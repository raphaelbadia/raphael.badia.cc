...
const Phenix = () => {
	...
	return (
		<div className="">
			<ExperienceHeader title="Epitech - 42" className="bg-gray-900" />
			<ExperienceBody>
				...
				<Stack space="5">
					<>
						...
						<ul class="list-disc my-3">
							<li>
								Réécriture des principales fonctions de la libC (librairie
								standard du C)
							</li>
							<li>Réécriture de la fonction printf</li>
							<li>
								Développement d’un programme en ligne de commande pour
								sélectionner plusieurs fichiers et les piper à un autre
								programme
							</li>
							<li>
								réalisation d’un interpréteur de commande UNIX (shell) de type
								bash
							</li>
							<li>Développement d’un mini chat via les signaux UNIX</li>
							<li>
								développement d'un compilateur et d'une machine virtuelle en
								suivant des spécifications
							</li>
						</ul>
					</>
					<>
						...
						<ul class="list-disc my-3">
							...
							<li>
								Développement d'un jeu interactif en 3D (similaire à
								Wolfenstein) via la technique du raycasting
							</li>
						</ul>
					</>
					<>
						...
						<ul class="list-disc my-3">
							...
							<li>
								Développement d’un programme qui trouve la plus grande zone
								libre dans une map remplie d’obstacles
							</li>
							<li>
								Développement d’un Tetris dans le terminal utilisant la
								librairie ncurses
							</li>
							<li>
								Développement d’un programme permettant de jouer avec mon IA au
								jeu des allumettes
							</li>
							<li>
							...
							<li>
								Développement d’un programme (IA) dans le cadre d’un jeu de
								plateau tour par tour dont l’objectif est d’être le dernier à
								poser des pièces
							</li>
							<li>
					...
					<>
						...
						<ul class="list-disc my-3">
							...
							<li>
								Développement d’un site de rencontre (node.js, express, vue,
								Mongo)
							</li>
							<li>
